function PTBOrientationWColorMatchBW_Mnky(width, stimCenter, preStimTime, stimTime, rampTime, blendDistance , numReps, staticPresentation, color2match, doNotSendEvents)
...
%                         and cone isolating stimuli stimulus 
%                         (1: L cone ++, 2: M cone --, 3: L/M ++, 
%                         4: S cone --)
%           doNotSendEvents - Flag to no send events out through 
%                             USB-1208FS, used for testing purposes 

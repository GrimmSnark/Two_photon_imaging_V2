...
function lgraph = createUnet2P(inputTileSize)

% creates U Net for 2P data....
% Pulled from the Semantic Segmentation of Multispectral Images Using Deep
% Learning MATLAB example
